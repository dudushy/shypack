...
#execute follow
execute as @a[scores={spec_follow=1},tag=!spec] run tag @s add spec
execute as @a[scores={spec_follow=1},tag=spec] run tag @e[distance=..1,scores={spec_already=0},tag=!spec,limit=1] add follow
